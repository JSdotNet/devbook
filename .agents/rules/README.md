...
`devbook:install`, between its markers — already states the folder routing table for both
hosts, so a path-scoped copy here would be the second copy this convention
