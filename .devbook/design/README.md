...
`devbook-graph` renders the reference graph from the same graph module the checker builds it
with, which is what makes the live view and the check unable to disagree — a second
