...
```meta
type: feature
related: [".devbook/domain/devbook/skills.md#check", ".devbook/domain/devbook-derived/skills.md#install", ".devbook/arc42/adr/79-the-checker-is-devbooks-the-committed-index-is-derived.md"]
```
