...
into. Two halves in one folder: sixteen `schedule-*` entry points that pick their own input and
run a flow, a review, a sweep, or a report, and thirteen files under `resources/schedules/`, each a cadence, a target
