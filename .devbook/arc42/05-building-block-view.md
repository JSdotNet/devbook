...
into. Two halves in one folder: ten `schedule-*` entry points that pick their own input and
run a flow or a review, and seven files under `resources/schedules/`, each a cadence, a target
