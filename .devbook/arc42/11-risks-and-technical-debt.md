...
| [5. The derived index is not optional](tdr/5-derived-index-is-not-optional.md) | 2026-09-08 | Medium | resolved | devbook shipped the derived `_meta/` index as foundation although nothing here read it. Resolved on 2026-09-17 by [record 76](adr/76-derived-artifacts-are-computed-never-committed.md): the generator writes no file, and every derived document is built where it is read. |
