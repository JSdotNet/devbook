# 81. The Checker Is devbook's; the Committed Index Is devbook-derived's

```meta
date: 2026-09-17
related: [".devbook/arc42/09-architecture-decisions.md", ".devbook/arc42/adr/5-devbook-still-ships-the-graph-canvas.md", ".devbook/arc42/adr/29-automation-owns-the-_meta-refresh.md", ".devbook/arc42/adr/60-the-annotation-lifecycle-ends-in-devbook.md", ".devbook/arc42/adr/64-1-0-0-is-the-first-release.md", ".devbook/arc42/adr/79-the-tooling-is-devbook-deriveds.md", ".devbook/arc42/tdr/5-derived-index-is-not-optional.md", ".devbook/domain/devbook/domain.md#index-generator", ".devbook/domain/devbook-derived/domain.md", ".devbook/domain/plugin-authoring/domain.md#layer"]
```
...
that materializes them. This supersedes [record 79](79-the-tooling-is-devbook-deriveds.md) and
...
to". Record 79 declined that and moved the whole folder; its amendment then moved the skills
...
on 2026-09-17 and what record 79's shape could not offer, because there the check went with it.
...
Record 79's context chapters — Index Generator, Canvas, Fence Writer, Tech Inventory — return
