...
| [Releases](releases.md) | Every plugin `1.9.0`, moved together; a contract bump is a minor release and ships a migration when one is owed, which lives for one major; the marketplace name is a frozen per-machine key. | 2026-09-26 |
